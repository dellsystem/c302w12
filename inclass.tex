...
Should we be able to supply a \verb~real ref~ (e.g. \verb~x~) whenever an \verb~int ref~ is required? YES. This seems almost contractitory, since we said yes to the previous question. The following rule seems incompatible to the one before:
